/*! vue-grid-layout - 2.3.11 | (c) 2015, 2022  Gustavo Santos (JBay Solutions) <gustavo.santos@jbaysolutions.com> (http://www.jbaysolutions.com) | https://github.com/jbaysolutions/vue-grid-layout */
module.exports =
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"9623503a-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/GridLayout.vue?vue&type=template&id=62170640&
...
// CONCATENATED MODULE: ./src/components/GridLayout.vue?vue&type=template&id=62170640&
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      this.$nextTick(function () {
        ...
        Object(utils["c" /* compact */])(self.layout, self.verticalCompact, self.forceAbsolute);
  ...
  methods: {
    layoutUpdate: function layoutUpdate() {
      if (this.layout !== undefined && this.originalLayout !== null) {
        ...
        Object(utils["c" /* compact */])(this.layout, this.verticalCompact, this.forceAbsolute);
        this.eventBus.$emit("updateWidth", this.width);
        this.updateHeight();
    ...
    dragEvent: function dragEvent(eventName, id, x, y, h, w) {
      ...
      this.layout = Object(utils["g" /* moveElement */])(this.layout, l, x, y, true, this.preventCollision, this.forceAbsolute);
      Object(utils["c" /* compact */])(this.layout, this.verticalCompact, this.forceAbsolute); // needed because vue can't detect changes on array element properties
    ...
    responsiveGridLayout: function responsiveGridLayout() {
      ...
      var layout = Object(responsiveUtils["a" /* findOrGenerateResponsiveLayout */])(this.originalLayout, this.layouts, this.breakpoints, newBreakpoint, this.lastBreakpoint, newCols, this.verticalCompact, this.forceAbsolute); // Store the new layout.
...
/*: Layout*/
{
  if (forceAbsolute) return layout; // Statics go in the compareWith array right away so items flow around them.
...
/*: Layout*/
{
  ...
  l.moved = true;
  if (forceAbsolute) return layout; // If this collides with anything, move it.
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"9623503a-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/GridItem.vue?vue&type=template&id=86f99088&
...
// CONCATENATED MODULE: ./src/components/GridItem.vue?vue&type=template&id=86f99088&
